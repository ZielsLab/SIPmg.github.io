...
[Identification of incorporators based on qSIP, ΔBD, or DESeq2 methods][SIP metagenomics and identification of isotope incorporators]
...
4.	Coefficient of variation. In this dataset, a higher coefficient of variation compared to the value used in the example workflow of the [introduction vignette][Using SIPmg R package] is used to allow data scaling to occur.
